...
/**
 * Constant for social urls.
 * @type {({svg: string, url: string}|{svg: string, url: string}|{svg: string, url: string})[]}
 */
const socialUrls = [
...
/**
 * Response of JSON urls and html.
